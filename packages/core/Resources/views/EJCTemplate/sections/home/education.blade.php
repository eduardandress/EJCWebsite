      ...
      <div id="content">
        <div class="row">
          <div class="col s12 m12 l12">
            <h4 class="gray-text dark-4 header">B.S. Computer Science</h4>
            ...
            <ul class="timeline">
             <li class="event" data-date="2010/2011">
              ...
              <li class="event" data-date="2012/2013">
              ...
              <li class="event" data-date="2012/2013">
                ...
                <p>
                  As long as we started to realize how complexed a real web application could end up being, we learned the importance of a good project structure and the advantages of using web frameworks. We learned a lot about them, how to use them, when and when not to use them, etc. Also, we applied architectural patterns like REST and SOAP which provide scalability to the apps.
                </p>
              ...
              <li class="event" data-date="2013/2014">
                <h3>Networks Fundamentals & Computer Graphics</h3>
                <p>
                 Well... we learned the building blocks of modern network design. Essentially, we learned about the many different types of networks, networking concepts, network architecture, network communications and network design.
                </p>
                <p>
                 Do you know how they make all these Disney movies, animations and video games? Using Computer Graphics! well... we didn't make 'Finding nemo' or something like that... but we learned the basics of graphic computing and programmed some 2D and 3D images :D.
                </p>
              </li>
              ...
              <li class="event" data-date="2014/2015">
                <h3>Computer Systems Performance Evaluation </h3>
                <p>
                  Here we learned all about how to measure and optimize the performance of an IT architecture. Learned how to identify and solve bottlenecks in any IT component, capacity management. In a nutshell: all the ITSM (IT Service Management) lifecycle stages using its 'bible' ITIL.
                </p>
              </li>
            </ul>
          </div>
